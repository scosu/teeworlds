...
void CGameContext::CreateExplosion(vec2 Pos, int Owner, int Weapon, bool NoDamage, float InnerRadius, float Radius, int Damage, int NoSelfDamage)
{
	// create the event
	...
	for(int i = 0; i < Num; i++)
	{
		if (NoSelfDamage && apEnts[i]->GetPlayer()->GetCID() == Owner)
			continue;
